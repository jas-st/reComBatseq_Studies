...
experiment <- "2(9)"
folder <- "SAMPLES"
N_total_sample <- round(2^9) # total number of samples
...
for(iter in 1:5){
  ...
  batch_df <- read.csv(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                                 "/experiment_",experiment,
                                 "/iter",iter,"_batch_df.csv"), row.names=1)
  nobatch_df <- read.csv(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                                 "/experiment_",experiment,
                                 "/iter",iter,"_nobatch_df.csv"), row.names=1)
  combatseq_df <- read.csv(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                                 "/experiment_",experiment,
                                 "/iter",iter,"_combatseq_df.csv"), row.names=1)
  recombatseq_df <- read.csv(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                                 "/experiment_",experiment,
                                 "/iter",iter,"_recombatseq_df.csv"), row.names=1)
  ...
  ggar1_1 <- ggarrange(plot_group1, plot_group2, leg, nrow=1, ncol=3,
                       common.legend = TRUE, legend = "none")

  ggar1_2 <- ggarrange(plot_group3, plot_group5, plot_group4, nrow=1, ncol=3,
                       common.legend = TRUE, legend = "none")
  ...
  ggar2_1 <- ggarrange(plot_batch1, plot_batch2, blank, nrow=1, ncol=3,
                       common.legend = TRUE, legend = "none")
  ggar2_2 <- ggarrange(plot_batch3, plot_batch5, plot_batch4, nrow=1, ncol=3,
                       common.legend = TRUE, legend = "none")
  ...
  ggsave(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                "/experiment_",experiment,
                "/iter",iter,"_PCAplots.png"), height=10, width=10, dpi=300)

  # Differential expression recombat
  if (recombatDE) {
    de_genes <- readRDS(paste0("/Users/zhasmina/Desktop/EXPERIMENTS/",folder,
                               "/experiment_",experiment,
    ...
    rm(de_genes, vfit, efit, tests, recombat_cor)
  }
